...
describe('Container service', () => {
    ...
    it('define and get metadata err', () => {
        const value = container.get<{ test: string }>(Example, 'define-and-get-err')
    ...
    it('define and get metadata with propertyKey', () => {
        const value = container.get<{ test: string }>(Example, 'define-and-get-prop', 'prop')
        expect(value.test).toEqual('test')
    })

    it('define and get metadata with propertyKey err', () => {
        const value = container.get<{ test: string }>(Example, 'define-and-get-prop', 'prop-err')
        expect(value).toBeUndefined()
    })
    ...
    it('define and getOwn metadata err', () => {
        const value = container.get<{ test: string }>(Example, 'define-and-getOwn-err')
        expect(value).toBeUndefined()
    })
    ...
    it('define and getOwn metadata with propertyKey', () => {
        const value = container.get<{ test: string }>(Example, 'define-and-getOwn-prop', 'prop')
        expect(value.test).toEqual('test')
    })

    it('define and getOwn metadata with propertyKey err', () => {
        const value = container.get<{ test: string }>(Example, 'define-and-getOwn-prop', 'prop-err')
        expect(value).toBeUndefined()
    })
