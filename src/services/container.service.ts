...
export class Container {
     ...
     */
    public define<T = unknown>(Target: Constructable | Function | Object, value: T, key: MetadataKeys | string, propertyKey?: string | symbol): void {
     ...
     */
    public get<T = unknown>(Target: Constructable | Function | Object, key: MetadataKeys | string, propertyKey?: string | symbol): T {
        // if propertyKey is given.
        if (propertyKey) {
     ...
     * @returns the metadata value for the metadata key if found; otherwise, undefined.
     */
    public getOwn<T = unknown>(Target: Constructable | Function | Object, key: MetadataKeys | string, propertyKey?: string | symbol): T {
        // if propertyKey is given.
        if (propertyKey) {
     ...
     */
    public has(Target: Constructable | Function | Object, key: MetadataKeys | string, propertyKey?: string | symbol): boolean {
        // If propertyKey is given.
        if (propertyKey) {
